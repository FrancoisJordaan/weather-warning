...
export class App extends React.Component {
	...
	getWeather = async () => {
		try {
			const response = await fetch(`https://ec-weather-proxy.appspot.com/forecast/29e4a4ce0ec0068b03fe203fa81d457f/-33.9249,18.4241?delay=5&chaos=0.2/api.darksky.net/forecast/29e4a4ce0ec0068b03fe203fa81d457f/-33.9249,18.4241?exclude=flags,alerts,daily`);
